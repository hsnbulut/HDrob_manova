...
The manuscript proposes a weighted minimum regularised covariance determinant (MRCD)-based robust Wilks' Lambda test for one-way high-dimensional MANOVA. The proposed method is designed for settings where the number of variables is comparable to, or larger than, the sample size and where the data may contain outlying observations.
